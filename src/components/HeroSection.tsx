...
const HeroSection = () => {
    return (
        <div className="md:h-screen relative bg-[#F9FAFB] text-black">
            <div className="w-[88%] mx-auto relative  max-lg:pt-[8rem]  max-md:pt-[calc(6rem)] items-center  lg:flex justify-between  gap-24">
                <div className="flex-1 space-y-4">
                    <h2 className="md:text-6xl text-3xl font-semibold max-md:text-center">Obafemi Awolowo University</h2>
                    <p className="text-[#1e293bb3] max-md:text-center  md:text-xl tracking-normal">
